...
func NewNullLogger() Logger {
	return Logger{
		...
		Info:  log.New(ioutil.Discard, "INFO:  ", log.Ltime|log.Lshortfile),
		Warn:  log.New(ioutil.Discard, "WARN:  ", log.Ltime|log.Lshortfile),
		Error: log.New(ioutil.Discard, "ERROR: ", log.Ltime|log.Lshortfile),
	}
}
